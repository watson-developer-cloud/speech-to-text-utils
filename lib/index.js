...
program
  ...
  .option('-v, --verbose', 'Print detailed results')
  .action((cmd) => getCommands(cmd)
...
program
  .command('customization-add-corpus')
  .description('Add a new corpus (i.e. workspace.json) to an existing customization')
  .option('-u, --username [username]', 'Speech to text username')
  .option('-p, --password [password]', 'Speech to text password')
  .option('-w, --workspace <workspace>', 'The Conversation JSON file (workspace.json) that is to be parsed')
  .option('-n, --corpus_name <name>', 'The name of the new corpus')
  .option('-i, --customization_id <id>', 'The customization identifier')
  .option('-o, --allow_overwrite', 'Specify this option to allow an existing corpus with the same name to be overwritten.')
  .option('-v, --verbose', 'Print detailed results')
  .action((cmd) => getCommands(cmd)
    .addCorpusToCustomization(cmd)
