...
class Commands {
  ...
  addCorpusToCustomization(params) {
    return promptForInput('customization_id')(params)
    .then(customization =>
      promptForInput('corpus_name', `My_corpus_${Date.now()}`)(params)
      .then(corpusName =>
        promptForJSONFile('workspace')(params)
        .then(workspace =>
          ...
          .then(() =>
            this.speechService.whenCorporaAnalyzedAsync(customization)
          )
          .then(() =>
